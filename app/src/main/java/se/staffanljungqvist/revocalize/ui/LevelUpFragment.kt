...
fun showInfo() {
    ...
    val text = when (model.level) {
        ...
        2 -> "WAY TO GO! YOU NOW GET ANOTHER HELPER. PRESS \"REMOVE\" TO SUBTRACT ONE DIVISION."
        3 -> "WELL DONE! YOU GET ANOTHER HELPER. PRESS \"TOUCH\" TO GO IN TO TOUCH MODE, THE BLOCKS CAN'T BE MOVED BUT YOU CAN HEAR EACH SOUND BY PRESSING THEM. MEMORIZE THE ORDER AND PRESS \"TOUCH DONE\" WHEN READY."
        4 -> "WOW, YOU MADE IT FAR! LAST LEVEL NOW. YOU DON'T GET ANY NEW HELPERS FROM HERE ON SO MAKE THE MOST OF THE ONES YOU GOT!"
